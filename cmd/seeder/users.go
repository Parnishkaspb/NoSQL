...
type User struct {
	...
	Name     string             `faker:"first_name" bson:"name"`
	Surname  string             `faker:"last_name" bson:"surname"`
	Login    string             `faker:"username" bson:"login"`
	Password string             `faker:"password" bson:"password"`
	Age      int                `bson:"age"`
}
